...
public class SampleScript2 : MonoBehaviour
{
    ...
    IEnumerator Tests()
    {
        ...
        SimpleFirebaseUnity.Firebase firebase = SimpleFirebaseUnity.Firebase.CreateNew("https://naxs-u-dev.firebaseio.com", "AIzaSyAFVj4NxNPPU1DwqlNJv84zwj_HaOHliQI");
        firebase = firebase.Child("SampleTest");
        ...
        SimpleFirebaseUnity.Firebase temporary = firebase.Child("Test");
        temporary.GetValue();
