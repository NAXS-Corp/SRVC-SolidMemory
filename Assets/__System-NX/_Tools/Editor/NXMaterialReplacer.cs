...
//     public Material ReplceWith;
//     public int GOCount = 0;
//     public List<GameObject> GOList;
// }

// public class NXMaterialReplacer : EditorWindow
// {
// 	/// -----------------------------------------------------------------------
// 	/// <summary>
...
// 	/// </summary>
// 	SortedDictionary<Material, ReplaceInfo> mMaterialMap = new SortedDictionary<Material, ReplaceInfo>( new MaterialComp() );
...
// 	/// </summary>
// 	// ------------------------------------------------------------------------
// 	[MenuItem ("Tools/NX Material Replacer")]
// 	static void Init()
// 	{
...
// 					if( mat != null )
// 					{
// 						mMaterialMap[mat].ReplceWith = mat;
...
// 			foreach( KeyValuePair<Material,ReplaceInfo> pair in mMaterialMap )
// 			{
