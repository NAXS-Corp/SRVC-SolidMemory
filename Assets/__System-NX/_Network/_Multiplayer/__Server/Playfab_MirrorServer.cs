    ...
    public class Playfab_MirrorServer : NetworkManager
    {
        ...
        public override void Awake()
        {
            ...
            if(GetCommandArg("MaxConnection") != null ){
                ...
                if(maxConArg > 0){
                    Debug.Log("================= Set maxConArg: "+maxConArg+" ============================");
        ...
        {
            NXDebug.Log(string.Concat("+ OnServerConnect:: ", numPlayers, " active players"));
        ...
        public override void OnServerError(NetworkConnection conn, int errorCode)
        {
			...
			try
			{
				...
				if (errorCode != 0)
				{
					NXDebug.Log(string.Format("Unity Network Connection Status: code - {0}", errorCode));
				}
			}
			catch (Exception)
			{
				NXDebug.Log("Unity Network Connection Status, but we could not get the reason, check the Unity Logs for more info.");
			}
        }
        ...
        public override void OnServerDisconnect(NetworkConnection conn)
        {
            ...
            NXDebug.Log(string.Concat("- OnServerDisconnect:: ", numPlayers, " active players"));
